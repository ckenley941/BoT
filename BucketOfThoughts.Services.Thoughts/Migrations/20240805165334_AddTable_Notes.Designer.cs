...
namespace BucketOfThoughts.Services.Thoughts.Migrations
{
    ...
    [Migration("20240805165334_AddTable_Notes")]
    partial class AddTable_Notes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BucketOfThoughts.Services.Thoughts.Data.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BucketOfThoughts.Services.Thoughts.Data.OutdoorActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ActivityDayOfWeek")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<double?>("ActivityLength")
                        .HasColumnType("float");
                    ...
                    b.ToTable("OutdoorActivityLog", (string)null);
                });
            ...
            modelBuilder.Entity("BucketOfThoughts.Services.Thoughts.Data.Thought", b =>
                {
                    b.HasOne("BucketOfThoughts.Services.Thoughts.Data.ThoughtBucket", "ThoughtBucket")
                        .WithMany("Thoughts")
