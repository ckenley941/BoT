...
namespace BucketOfThoughts.Services
{
    public class WordsService : IWordsService
    {
        ...
        public WordsService(EnsenaMeContext dbContext)
        {   
        ...
        {
            var word = await AddWordIfNotExistsAsync(insertedWord.PrimaryWord, (int)EnsenaMe.Data.Enums.Lanugage.Spanish);
            ...
            {
                var word2 = await AddWordIfNotExistsAsync(wordDict.Word, (int)EnsenaMe.Data.Enums.Lanugage.English);              
